...
def create_easy_button():
    ...
    button1_surface.fill((255, 192, 203))

    text_button1 = button1_font.render("Easy", True, (0,0,0))
...
def create_medium_button():
    ...
    button2_surface.fill((255, 192, 203))

    text_button2 = button2_font.render("Medium", True, (0,0,0))
...
def create_hard_button():
    ...
    button3_surface.fill((255, 192, 203))

    text_button3 = button3_font.render("Hard", True, (0,0,0))
...
def create_exit2_button():
    ...
    button4_surface.fill((255, 192, 203))

    text_button4 = button4_font.render("EXIT", True, (0, 0, 0))
...
def create_restart2_button():
    ...
    button5_surface = pygame.Surface((120, 50))
    button5_surface.fill((255, 192, 203))


    text_button5 = button5_font.render("RESTART", True, (0, 0, 0))
    ...
    button_rectangle5 = pygame.Rect(250, 360, 100, 75)
